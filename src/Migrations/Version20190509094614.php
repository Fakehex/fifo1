 ...
 */
final class Version20190509094614 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bracket ADD tour_perdant INT DEFAULT NULL');
        $this->addSql('ALTER TABLE duel ADD bracket_double_id INT DEFAULT NULL, CHANGE inscrit1_id inscrit1_id INT DEFAULT NULL, CHANGE inscrit2_id inscrit2_id INT DEFAULT NULL, CHANGE bracket_id bracket_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE duel ADD CONSTRAINT FK_9BB4A76258B4A49B FOREIGN KEY (bracket_double_id) REFERENCES bracket (id)');
        $this->addSql('CREATE INDEX IDX_9BB4A76258B4A49B ON duel (bracket_double_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE archives CHANGE matiere_id matiere_id INT DEFAULT NULL, CHANGE date date DATE DEFAULT \'NULL\', CHANGE seconde_session seconde_session TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE bracket DROP tour_perdant');
        $this->addSql('ALTER TABLE duel DROP FOREIGN KEY FK_9BB4A76258B4A49B');
        $this->addSql('DROP INDEX IDX_9BB4A76258B4A49B ON duel');
        $this->addSql('ALTER TABLE duel DROP bracket_double_id, CHANGE inscrit1_id inscrit1_id INT DEFAULT NULL, CHANGE inscrit2_id inscrit2_id INT DEFAULT NULL, CHANGE bracket_id bracket_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE evenement CHANGE bracket_id bracket_id INT DEFAULT NULL, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE inscrit CHANGE maison_id maison_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE equipe_id equipe_id INT DEFAULT NULL, CHANGE leader_id leader_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE maison CHANGE points points INT DEFAULT NULL');
        $this->addSql('ALTER TABLE matiere CHANGE categorie_id categorie_id INT DEFAULT NULL');
