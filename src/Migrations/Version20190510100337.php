 ...
 */
final class Version20190510100337 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE archives CHANGE matiere_id matiere_id INT DEFAULT NULL, CHANGE date date DATE DEFAULT \'NULL\', CHANGE seconde_session seconde_session TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE bracket CHANGE tour_perdant tour_perdant INT DEFAULT NULL');
        $this->addSql('ALTER TABLE duel ADD inscrit1_id INT DEFAULT NULL, ADD inscrit2_id INT DEFAULT NULL, DROP inscrit1, DROP inscrit2, CHANGE bracket_id bracket_id INT DEFAULT NULL, CHANGE bracket_double_id bracket_double_id INT DEFAULT NULL, CHANGE score_inscrit1 score_inscrit1 INT NOT NULL, CHANGE score_inscrit2 score_inscrit2 INT NOT NULL');
