 ...
 */
final class Version20190502133740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD bracket_id INT DEFAULT NULL, ADD type VARCHAR(255) NOT NULL, CHANGE date date DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT FK_B26681E6E8D78 FOREIGN KEY (bracket_id) REFERENCES bracket (id)');
        $this->addSql('CREATE INDEX IDX_B26681E6E8D78 ON evenement (bracket_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B26681E6E8D78 ON evenement');
        $this->addSql('ALTER TABLE evenement DROP bracket_id, DROP type, CHANGE date date DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE inscrit CHANGE maison_id maison_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE equipe_id equipe_id INT DEFAULT NULL, CHANGE leader_id leader_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE maison CHANGE points points INT DEFAULT NULL');
        $this->addSql('ALTER TABLE matiere CHANGE categorie_id categorie_id INT DEFAULT NULL');
