 ...
 */
final class Version20190429082339 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `match` CHANGE inscrit1_id inscrit1_id INT DEFAULT NULL, CHANGE inscrit2_id inscrit2_id INT DEFAULT NULL');
