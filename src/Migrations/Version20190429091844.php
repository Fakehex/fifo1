 ...
 */
final class Version20190429091844 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE duel (id INT AUTO_INCREMENT NOT NULL, inscrit1_id INT DEFAULT NULL, inscrit2_id INT DEFAULT NULL, score_inscrit1 INT NOT NULL, score_inscrit2 INT NOT NULL, tour INT NOT NULL, INDEX IDX_9BB4A76291B32FA3 (inscrit1_id), INDEX IDX_9BB4A7628306804D (inscrit2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
