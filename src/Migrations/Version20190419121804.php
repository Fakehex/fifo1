 ...
 */
final class Version20190419121804 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE correction ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE correction ADD CONSTRAINT FK_A29DA1B8A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_A29DA1B8A76ED395 ON correction (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_A29DA1B8A76ED395 ON correction');
        $this->addSql('ALTER TABLE correction DROP user_id');
        $this->addSql('ALTER TABLE matiere CHANGE categorie_id categorie_id INT DEFAULT NULL');
