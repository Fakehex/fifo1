 ...
 */
final class Version20190617135715 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE duel CHANGE bracket_id bracket_id INT DEFAULT NULL, CHANGE bracket_double_id bracket_double_id INT DEFAULT NULL, CHANGE inscrit_id inscrit_id INT DEFAULT NULL, CHANGE score_inscrit1 score_inscrit1 INT DEFAULT NULL, CHANGE score_inscrit2 score_inscrit2 INT DEFAULT NULL');
