 ...
 */
final class Version20190617130332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9BB4A7626DCD4FEE ON duel (inscrit_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_9BB4A7626DCD4FEE ON duel');
        $this->addSql('ALTER TABLE duel ADD inscrit1_id INT DEFAULT NULL, ADD inscrit2_id INT DEFAULT NULL, DROP inscrit_id, CHANGE bracket_id bracket_id INT DEFAULT NULL, CHANGE bracket_double_id bracket_double_id INT DEFAULT NULL, CHANGE score_inscrit1 score_inscrit1 INT DEFAULT NULL, CHANGE score_inscrit2 score_inscrit2 INT DEFAULT NULL');
